...
const KnowlageHubSmallCard = ({
  ...
  return (
    <>
      <div className="w-full h-fit bg-white rounded-lg flex flex-col-reverse xl:flex-row p-2 gap-2">
        <div className="w-full h-auto flex flex-col justify-center gap-4 p-4">
          ...
          <div className="h-full flex flex-col gap-4 justify-end">
            <p className="text-xl/snug xl:text-2xl/snug font-medium text-slate-800 line-clamp-2">
              {title}
            </p>
        ...
        <div className="w-full xl:w-48 h-48 flex shrink-0 rounded-md bg-dodger-blue-500 relative overflow-hidden">
          <Image
